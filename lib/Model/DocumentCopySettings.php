...
use \ArrayAccess;
/**
 * DocumentCopySettings Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DocumentCopySettings implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    static $swaggerModelName = 'DocumentCopySettings';
    ...
    /**
      * $document_id_list The Id list of the documents you want to copy
      * @var string[]
      */
    protected $document_id_list;
    
    /**
      * $target_data_set_name The DataSet name where you want to copy the selected documents
      * @var string
      */
     ...
     * @param string[] $document_id_list The Id list of the documents you want to copy
     * @return $this
     */
     ...
     * @param string $target_data_set_name The DataSet name where you want to copy the selected documents
     * @return $this
     */
